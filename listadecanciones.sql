...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-04-2025 a las 10:01:21
...
--
-- Base de datos: `listadecanciones`
--
...
CREATE TABLE `artistas` (
  ...
  `nombrePais` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
INSERT INTO `artistas` (`idArtistas`, `nombre`, `nombrePais`, `iso`, `pais`) VALUES
(1, 'In Mourning', 'Suecia', 'SE', 205),
(2, 'Funkadelic', 'Estados Unidos', 'US', 226),
(3, 'Pantera', 'Estados Unidos', 'US', 226),
(4, 'Berri Txarrak', 'España', 'ES', 199),
(5, 'Alice in Chains', 'Estados Unidos', 'US', 226),
(6, 'Mad Season', 'Estados Unidos', 'US', 226),
(7, 'Frightened Rabbit', 'Reino Unido', 'UK', 225),
(8, 'Evergreen Terrace', 'Estados Unidos', 'US', 226),
(11, 'Tim McIlrath', 'Estados Unidos', 'US', 226),
(12, 'Michael Sembello', 'Estaados Unidos', 'US', 226);
...
INSERT INTO `artistas_canciones` (`id`, `idCanciones`, `idArtistas`) VALUES
(1, 1, 1),
(2, 2, 2),
(3, 3, 3),
(4, 4, 4),
...
CREATE TABLE `canciones` (
  ...
  `duracion` varchar(6) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
(1, 'Colossus', '9:33', 4, 0, 0),
(2, 'Maggot Brain', '10:18', 10, 0, 0),
(3, 'Floods', '7:03', 5, 0, 0),
(4, 'Gezur bat mila aldiz', '4:36', 9, 0, 0),
(5, 'Nutshell', '4:16', 11, 0, 0),
(6, 'Slip Away', '5:39', 6, 0, 0),
(7, 'My Backwards Walk', '3:29', 7, 0, 0),
(8, 'Maniac', '3:13', 9, 1, 12),
(9, 'Denak ez du balio', '4:13', 9, 0, 0);
...
INSERT INTO `paises` (`id`, `iso`, `name`, `nicename`, `iso3`, `numcode`, `phonecode`) VALUES
...
--
ALTER TABLE `artistas`
  MODIFY `idArtistas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
